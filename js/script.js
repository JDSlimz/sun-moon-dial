...
function loadWeather(lat, lng) {
	console.log('https://api.wunderground.com/api/6a6a5af963e13dd8/geolookup/q/'+lat+','+lng+'.json');
	$.ajax({
	  dataType: "json",
	  url: 'https://api.wunderground.com/api/6a6a5af963e13dd8/geolookup/q/'+lat+','+lng+'.json',
